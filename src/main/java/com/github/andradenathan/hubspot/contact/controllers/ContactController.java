...
public class ContactController {
    ...
    @PostMapping
    public ResponseEntity<BaseResponse> create(@RequestBody CreateContactRequestDTO createContactDTO) {
        CreateContactResponseDTO createContactResponseDTO = contactService.createContact(createContactDTO);
